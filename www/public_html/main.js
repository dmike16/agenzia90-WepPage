    ...
    */
    getUniqueId  : (function () {
        ...
        if (typeof document.documentElement.uniqueID !== 'undefined') {
            return function getUniqueId(element) {
     ...
     */
    isHostMethod: function isHostMethod(obj, methodName) {
        "use strict";
...
dmUtil.EventUtil.aboutHandler= (function () {
    ...
    if (dmUtil.EventUtil.isHostMethod(docE, 'addEventListener') && dmUtil.EventUtil.isHostMethod(docE, 'removeEventListener')) {
        docE = null;
        return {
            /**
            ...
            * @return {Void}
            */
            addListener : function addListener(element, eventName, handler, capture) {
            ...
            * 
            */
            removeListener: function removeListener(element, eventName, handler, capture) {
                element.removeEventListener(eventName, handler, capture);
            }
        };
    } else if (dmUtil.EventUtil.isHostMethod(docE, 'attachEvent') && dmUtil.EventUtil.isHostMethod(docE, 'deatachEvent')) {
        ...
        ,wrapper = function (uid, handler) {
            if (handler.handlerEvent) {
                ...
                return function (e) {
                    handler.call(getElement(uid), dmUtil.formatEvent(e || dmUtil.global.event));
                };
            }
        }
        ...
        return {
            ...
            removeListener: function removeListener(element, eventName, handler) {
                var uid = dmUtil.EventUtil.getUniqueId(element), listener;
...
dmUtil.arrayUtil={
    ...
    IndexOf: (function () {
        ...
        if (!Array.prototype.indexOf) {
            return function indexOf(arr, ele, fromIndex) {
                if(arr === null){
                    return -1;
                }
